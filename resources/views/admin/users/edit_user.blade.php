          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h2 class="card-title">Editer un Utilisateur</h2>

              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  
                  <form action="{{ route('admin-user-edit-valide') }}" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" placeholder="Nom et Prénoms" value="{{ $user->name }}" required="required">
                    </div>
                    <div class="form-group">
                      <label>Email *</label>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" required="required" name="role">
                        ...
                        @foreach( $roles as $r )
                        <option <?php if( $user->id == $r->id ){ echo "selected";} ?> value="{{ $r->id }}">{{ $r->name }}</option>
                        @endforeach
                      </select>
                    </div>
