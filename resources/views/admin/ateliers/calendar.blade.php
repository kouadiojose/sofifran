          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h2 class="card-title">Bloc Event</h2>
              ...
              <div class="card-body">
                  ...
                  <form action="{{ route('admin-edit-headerevent') }}" method="post">



                      {{ csrf_field() }}

                      <input type="hidden" name="event_id" value="{{ $headerEvent->id }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $headerEvent->nom_fr }}" class="form-control" name="nom_fr">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $headerEvent->nom_en }}" class="form-control" name="nom_en">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $headerEvent->title_fr }}" class="form-control" name="title_fr">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $headerEvent->title_en }}" class="form-control" name="title_en">
