...
@section('title', 'Creation calendrier')
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0 text-dark"> Création calendrier</h1>
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Création calendrier</li>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h2 class="card-title">Création calendrier</h2>

                <a href="{{ route('admin-atelier') }}" class="btn btn-secondary float-right"> <i class="fa fa-eye"></i> Voir le calendrier</a>
              ...
              <div class="card-body">
                  ...
                  <form action="{{ route('admin-atelier-valid') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Image de L'Evènement </label>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="time" name="hour_start" required="required" id="hour_start" class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="time" name="hour_end" required="required" id="hour_end" class="form-control">
                          </div>
                        </div>
