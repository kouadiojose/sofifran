<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      @can('view-project')
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin-projet') }}" class="nav-link">Projets</a>
      </li>
      @endcan
      @can('view-temoignage')
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin-temoignage') }}" class="nav-link">Témoignages</a>
      </li>
      @endcan
      @can('view-partenaire')
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin-partenaire') }}" class="nav-link">Partenaires</a>
      </li>
      @endcan
      @can('view-atelier')
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin-atelier') }}" class="nav-link">Ateliers</a>
      </li>
      @endcan
      @can('view-infolettre')
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('admin-infolettre') }}" class="nav-link">Infolettre</a>
      </li>
      @endcan
      @can('view-rubriques')
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{ route('admin-banieres') }}" class="dropdown-item">
            <i class="far fa-circle nav-icon"></i> Banières
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('admin-apropos') }}" class="dropdown-item">
            <i class="far fa-circle nav-icon"></i> A propos de nous 
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('admin-galerie') }}" class="dropdown-item">
            <i class="far fa-circle nav-icon"></i> Activités 
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('admin-blog') }}" class="dropdown-item">
