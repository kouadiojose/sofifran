...
@section('meta_description', \Illuminate\Support\Str::limit(strip_tags(app()->getLocale() == 'fr' ? $atelier->description_fr : $atelier->description_en), 160))
@if($atelier->image)@section('meta_image', url('/frontend/assets/images/ateliers/' . $atelier->image))@endif
