...
<?php
  ...
  if( app()->getLocale() == 'fr' ){
    ...
    $langue = 'Projets Terminés';

  }else{

    $langue = 'Completed Projects';
        ...
        <div class="d-table-cell">
            ...
            <div class="container">
                ...
                <div class="page-title-content">
                    ...
                    <h2>{{ app()->getLocale() == 'fr' ? 'Projets Terminés' : 'Completed Projects' }}</h2>

                    <ul>

                        <li><a href="{{route('index')}}">Accueil</a></li>

                        <li>{{ app()->getLocale() == 'fr' ? 'Projets Terminés' : 'Completed Projects' }}</li>
