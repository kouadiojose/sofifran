...
<?php
  if( app()->getLocale() == 'fr' ){
    $langue = 'Détail Projet';
  }else{
    $langue = 'Project Detail';
  }
?>

@section('title', $langue)

@section('meta_description', \Illuminate\Support\Str::limit(strip_tags(app()->getLocale() == 'fr' ? $projet->description_fr : $projet->description_en), 160))
@section('meta_image', url('/frontend/assets/images/projects/' . $projet->image))
            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="page-title-content">
                        <h2>{{ app()->getLocale() == 'fr' ? 'Détail Projet': 'Project Detail' }}</h2>
                        <ul>
                            <li><a href="{{ route('index') }}">{{ app()->getLocale() == 'fr' ? 'Accueil': 'Home' }}</a></li>
                            <li>{{ app()->getLocale() == 'fr' ? 'Détail Projet': 'Project Detail' }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="blog-details-desc">
                        <div class="article-image">
                            <img src="/frontend/assets/images/projects/{{ $projet->image }}" alt="image">
                        </div>

                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    <li><i class="fi fi-br-clock"></i> <a href="#">{{ date('d M Y', strtotime($projet->created_at)) }}</a></li>
                                </ul>
                            </div>

                            <h3>{{ app()->getLocale() == 'fr' ? $projet->titre_fr: $projet->titre_en }}</h3>

                            <p>
                            	<?= app()->getLocale() == 'fr' ? $projet->description_fr: $projet->description_en; ?>
                            </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-4">
                                <img src="/frontend/assets/images/projects/partenaires/{{ $p->image }}" width="100%">
                            </div>
                            <?php } ?>
                        </div>
                            ...
                            @foreach( $projets as $b )
	                            <article class="item">
	                                ...
	                                <div class="info">
	                                    ...
	                                    <h4 class="title usmall"><a href="{{ route('detail-projets', $b->slug) }}">{{ app()->getLocale() == 'fr' ? $b->titre_fr: $b->titre_en }}</a></h4>
	                                </div>
